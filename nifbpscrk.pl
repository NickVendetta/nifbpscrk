...
print "\033[1;32m                  [-------------------------------------------------------]\n";
print "\033[1;32m                  | NICK VENDETTA FACEBOOK PASSWORD CRACKER               |\n";
print "\033[1;32m                  | CREATED ON 17/1/2017                                  |\n"; 
print "\033[1;32m                  | THIS FACEBOOK PASSWORD CRACKER IS WRITTEN IN PERL     |\n";
print "\033[1;32m                  | EDIT THIS PASSWORD CRACKER WON'T MAKE YOU THE CODERZ  |\n";
print "\033[1;32m                  | RESPECT THE CODERZ^_^                                 |\n";
print "\033[1;32m                  | CODENAME:SPECTRE                                      |\n";
print "\033[1;32m                  [-------------------------------------------------------]\n";
...
print "\033[1;31m                  =========================================================\n";
print "\033[1;33m                   ####### Usage: perl nifbpscrk.pl id wordlist.txt #######\n";
print "\033[1;31m                  =========================================================\n";
print "\n";
print "\n";
print "\n";
